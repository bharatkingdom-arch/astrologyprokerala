...
<head>
    ...
    <title>Solstice | Astrology API Demo - Prokerala Astrology</title>
            ...
            <div class="row my-auto">
                <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12 text-lg-left top-header-text-content">
                    <h2 class="text-white mb-5">
                        <span class="font-weight-thin">Solstice</span>
                    </h2>
<!--                    <p class="text-white">Auspicious period shows results like Abhijit Muhurat, Amrit Kaal and Brahma Muhurat. <a class="text-warning" href="https://www.prokerala.com/astrology/panchangam/" target="_blank">Read More..</a></p>-->
    ...
    <div class="container prokerala-api-demo-container">
        ...
        <?php if(!empty($result)): ?>
            <h2 class="text-center text-black">Solstice</h2>
            <table class="table table-bordered text-large text-center table-hover">
                ...
                <tr class="border-top">
                    <td><?=$result->getDishaShool()->getName()?></td>
                    <td><?=$result->getDishaShool()->getVedicName()?></td>
                </tr>
            </table>
        <?php endif; ?>
            <section>
                <div class="card contact-form-wrapper box-shadow mx-auto rounded-2 mb-5">
                    <form class="p-5 text-default"  action="solstice.php" method="POST">
