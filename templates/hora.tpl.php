...
<head>
    ...
    <title>Hora | Astrology API Demo - Prokerala Astrology</title>
            ...
            <div class="row my-auto">
                <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12 text-lg-left top-header-text-content">
                    <h2 class="text-white mb-5">
                        <span class="font-weight-thin">Hora</span>
                    </h2>
<!--                    <p class="text-white">Auspicious period shows results like Abhijit Muhurat, Amrit Kaal and Brahma Muhurat. <a class="text-warning" href="https://www.prokerala.com/astrology/panchangam/" target="_blank">Read More..</a></p>-->
    ...
    <div class="container prokerala-api-demo-container">
        ...
        <?php if(!empty($result)): ?>
            <h2 class="text-center text-black">Hora Timing</h2>
            ...
            <div class="grid-col grid-col-xs-12 grid-col-sm-6">
                <div>
                    <table class="table table-bordered table-sm table-hora-result t-small">
                        ...
                        <tbody>
                        <?php foreach ($result->getDayHora() as $key => $data):?>
                            <tr class="border-top">
                ...
                <div>
                    <table class="table table-bordered table-sm table-hora-result t-small">
                        ...
                        <tbody>
                        <?php foreach ($result->getNightHora() as $key => $data):?>
                            <tr class="border-top">
                                <td><?=$data->getHora()->getName()?></td>
                                <td><?=$data->getType()?></td>
                                <td><?=$data->getStart()->format('h:i A') . ' - ' . $data->getEnd()->format('h:i A')?></td>
        ...
        <?php endif; ?>
            <section>
                <div class="card contact-form-wrapper box-shadow mx-auto rounded-2 mb-5">
                    <form class="p-5 text-default"  action="hora.php" method="POST">
