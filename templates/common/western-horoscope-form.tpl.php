    <div>
        <div class="form-group row">
            ...
            <div class="col-sm-9 col-md-6 ">
                <input type='datetime-local' name="datetime" class="form-control form-control-lg rounded-1" required="required" value="<?= $datetime->format('Y-m-d\TH:i')?>" min="<?= $time_now->modify('-1 days')->setTime(0,0,0)->format('Y-m-d\TH:i')?>" max="<?= $time_now->modify('+1 days')->setTime(23,59,0)->format('Y-m-d\TH:i')?>"/>
            </div>
        </div>
        ...
        <div class="form-group row d-none" id="birth_time_rectification_tab">
            ...
            <div class="col-sm-9 col-md-6 ">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="birth_time_rectification" id="birth_time_rectification1" value="flat-chart" <?='flat-chart' === $rectificationChart ? 'checked' : ''?>>
                    <label class="form-check-label" for="birth_time_rectification1">Flat Chart</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="birth_time_rectification" id="birth_time_rectification2" value="true-sunrise-chart" <?='true-sunrise-chart' === $rectificationChart ? 'checked' : ''?>>
                    <label class="form-check-label" for="birth_time_rectification2">True Sunrise Chart</label>
                </div>
            </div>
        </div>
    </div>
