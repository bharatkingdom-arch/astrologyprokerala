<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8 pl-md-0">
                <input type='datetime-local' name="girl_dob" class="form-control form-control-lg rounded-1"  required="required" value="<?= $girl_dob->format('Y-m-d\TH:i')?>" min="<?= $time_now->modify('-1 day')->setTime(0,0,0)->format('Y-m-d\TH:i')?>" max="<?= $time_now->modify('+1 day')->setTime(23,59,0)->format('Y-m-d\TH:i')?>"/>
            </div>
        </div>
    ...
    <div class="col-12 col-md-6">
        ...
        <div class="form-group row">
            <label class="col-md-4 pr-md-0 col-form-label">Date Of Birth:</label>
            <div class="col-md-8 pl-md-0">
                <input type='datetime-local' name="boy_dob" class="form-control form-control-lg rounded-1"  required="required" value="<?= $boy_dob->format('Y-m-d\TH:i')?>" min="<?= $time_now->modify('-1 day')->setTime(0,0,0)->format('Y-m-d\TH:i')?>" max="<?= $time_now->modify('+1 day')->setTime(23,59,0)->format('Y-m-d\TH:i')?>"/>
            </div>
        </div>
