...
<head>
    ...
    <title>Gowri Nalla Neram | Astrology API Demo - Prokerala Astrology</title>
            ...
            <div class="row my-auto">
                <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12 text-lg-left top-header-text-content">
                    <h2 class="text-white mb-5">
                        <span class="font-weight-thin">Gowri Nalla Neram</span>
                    </h2>
                </div>
            </div>
        </div>
    ...
    <div class="container prokerala-api-demo-container">
                    ...
                    <div class="col-12 col-md-6">
                        <table class="table table-bordered border-white table-hover table-responsive-sm" style="margin-right: 10px">
                            <tr class="bg-secondary text-white">
                                <th colspan="4" class="text-center"><?= $type ? 'Day' : 'Night'?> Gowri Nalla Neram</th>
                            </tr>
        ...
        <section>
            <div class="card contact-form-wrapper box-shadow mx-auto rounded-2 mb-5">
                <form class="p-5 text-default"  action="gowri-nalla-neram.php" method="POST">
